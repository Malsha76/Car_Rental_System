...
import dto.Reg_UserDTO;
import  entity.Reg_User;
import entity.User;
import enums.RoleType;
import repo.Reg_UserRepo;
import service.Reg_UserService;
...
public class Reg_UserServiceImpl implements Reg_UserService {
    ...
    public void deleteUser(String reg_ID) {
        if (!repo.existsById(reg_ID)) {
            throw new RuntimeException("Wrong ID..Please enter correct id!");
        }
